...
<?php include('../include/navbar.php'); ?>
                ...
                <div class="row pxp-pl-80 align-items-center justify-content-between">
                    ...
                    <div class="d-none d-xl-block col-xl-5 position-relative">
                        <div class="pxp-hero-cards-container pxp-animate-cards pxp-mouse-move" data-speed="160">
                            <div class="pxp-hero-card pxp-cover pxp-cover-top" style="background-image: url(assets/images/hero-bg-1.jpg);"></div>
                ...
                <div class="row pxp-pl-80">
                    <div class="col-12 col-xl-6">
                        <div class="pxp-hero-logos-carousel owl-carousel">
                            <img src="assets/images/hero-logo-1.svg" alt="Logo 1">
                            <img src="assets/images/hero-logo-2.svg" alt="Logo 2">
                            <img src="assets/images/hero-logo-3.svg" alt="Logo 3">
                            <img src="assets/images/hero-logo-4.svg" alt="Logo 4">
                            <img src="assets/images/hero-logo-5.svg" alt="Logo 5">
                            <img src="assets/images/hero-logo-6.svg" alt="Logo 6">
                            <img src="assets/images/hero-logo-7.svg" alt="Logo 7">
                            <img src="assets/images/hero-logo-1.svg" alt="Logo 8">
                            <img src="assets/images/hero-logo-2.svg" alt="Logo 9">
                            <img src="assets/images/hero-logo-3.svg" alt="Logo 10">
                        </div>
                    </div>
                </div>
            </div>
    ...
    <!-- Section Start {Search By Category} -->
    ...
    <!-- Section End {Search By Category} -->

    <!-- Section Start {Featured Job Offers} -->
                ...
                <div class="col-md-6 col-xl-4 col-xxl-3 pxp-jobs-card-1-container">
                    <div class="pxp-jobs-card-1 pxp-has-shadow">
                        ...
                        <div class="pxp-jobs-card-1-bottom">
                            ...
                            <a href="single-company-1.html" class="pxp-jobs-card-1-company-logo" style="background-image: url(assets/images/company-logo-1.png);"></a>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 col-xl-4 col-xxl-3 pxp-jobs-card-1-container">
                    <div class="pxp-jobs-card-1 pxp-has-shadow">
                        ...
                        <div class="pxp-jobs-card-1-bottom">
                            ...
                            <a href="single-company-1.html" class="pxp-jobs-card-1-company-logo" style="background-image: url(assets/images/company-logo-2.png);"></a>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 col-xl-4 col-xxl-3 pxp-jobs-card-1-container">
                    <div class="pxp-jobs-card-1 pxp-has-shadow">
                        ...
                        <div class="pxp-jobs-card-1-bottom">
                            ...
                            <a href="single-company-1.html" class="pxp-jobs-card-1-company-logo" style="background-image: url(assets/images/company-logo-3.png);"></a>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 col-xl-4 col-xxl-3 pxp-jobs-card-1-container">
                    <div class="pxp-jobs-card-1 pxp-has-shadow">
                        ...
                        <div class="pxp-jobs-card-1-bottom">
                            ...
                            <a href="single-company-1.html" class="pxp-jobs-card-1-company-logo" style="background-image: url(assets/images/company-logo-4.png);"></a>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 col-xl-4 col-xxl-3 pxp-jobs-card-1-container">
                    <div class="pxp-jobs-card-1 pxp-has-shadow">
                        ...
                        <div class="pxp-jobs-card-1-bottom">
                            ...
                            <a href="single-company-1.html" class="pxp-jobs-card-1-company-logo" style="background-image: url(assets/images/company-logo-5.png);"></a>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 col-xl-4 col-xxl-3 pxp-jobs-card-1-container">
                    <div class="pxp-jobs-card-1 pxp-has-shadow">
                        ...
                        <div class="pxp-jobs-card-1-bottom">
                            ...
                            <a href="single-company-1.html" class="pxp-jobs-card-1-company-logo" style="background-image: url(assets/images/company-logo-6.png);"></a>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 col-xl-4 col-xxl-3 pxp-jobs-card-1-container">
                    <div class="pxp-jobs-card-1 pxp-has-shadow">
                        ...
                        <div class="pxp-jobs-card-1-bottom">
                            ...
                            <a href="single-company-1.html" class="pxp-jobs-card-1-company-logo" style="background-image: url(assets/images/company-logo-7.png);"></a>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 col-xl-4 col-xxl-3 pxp-jobs-card-1-container">
    ...
    <!-- Section End {Featured Job Offers} -->

    <!-- Section Start {Find Best Companies} -->
    <section class="mt-100">
        <div class="pxp-container">
            ...
            <div class="row mt-4 mt-md-5 pxp-animate-in pxp-animate-in-top">
                <div class="col-md-6 col-xl-4 col-xxl-3 pxp-companies-card-1-container">
                    <div class="pxp-companies-card-1 pxp-has-border">
                        <div class="pxp-companies-card-1-top">
                            <a href="single-company-1.html" class="pxp-companies-card-1-company-logo" style="background-image: url(assets/images/company-logo-1.png);"></a>
                ...
                <div class="col-md-6 col-xl-4 col-xxl-3 pxp-companies-card-1-container">
                    <div class="pxp-companies-card-1 pxp-has-border">
                        <div class="pxp-companies-card-1-top">
                            <a href="single-company-1.html" class="pxp-companies-card-1-company-logo" style="background-image: url(assets/images/company-logo-7.png);"></a>
                ...
                <div class="col-md-6 col-xl-4 col-xxl-3 pxp-companies-card-1-container">
                    <div class="pxp-companies-card-1 pxp-has-border">
                        <div class="pxp-companies-card-1-top">
                            <a href="single-company-1.html" class="pxp-companies-card-1-company-logo" style="background-image: url(assets/images/company-logo-4.png);"></a>
                ...
                <div class="col-md-6 col-xl-4 col-xxl-3 pxp-companies-card-1-container">
                    <div class="pxp-companies-card-1 pxp-has-border">
                        <div class="pxp-companies-card-1-top">
                            <a href="single-company-1.html" class="pxp-companies-card-1-company-logo" style="background-image: url(assets/images/company-logo-3.png);"></a>
    ...
    <!-- Section End {Find Best Companies} -->

    <!-- Section Start {Featured Cities} -->
    <section class="mt-100">
        <div class="pxp-container">
            ...
            <div class="row mt-4 mt-md-5 pxp-animate-in pxp-animate-in-top">
                <div class="col-md-6 col-xl-4 col-xxl-3">
                    <a href="jobs-list-1.html" class="pxp-cities-card-2">
                        <div class="pxp-cities-card-2-image-container">
                            <div class="pxp-cities-card-2-image pxp-cover" style="background-image: url(assets/images/city-3.jpg);"></div>
                        </div>
                    ...
                    <a href="jobs-list-1.html" class="pxp-cities-card-2">
                        <div class="pxp-cities-card-2-image-container">
                            <div class="pxp-cities-card-2-image pxp-cover" style="background-image: url(assets/images/city-4.jpg);"></div>
                        </div>
                        <div class="pxp-cities-card-2-info">
                ...
                <div class="col-md-6 col-xl-4 col-xxl-3">
                    <a href="jobs-list-1.html" class="pxp-cities-card-2 pxp-is-featured">
                        <div class="pxp-cities-card-2-image-container">
                            <div class="pxp-cities-card-2-image pxp-cover" style="background-image: url(assets/images/city-6.jpg);"></div>
                        </div>
                        <div class="pxp-cities-card-2-info">
                ...
                <div class="col-md-6 col-xl-4 col-xxl-3">
                    <a href="jobs-list-1.html" class="pxp-cities-card-2">
                        <div class="pxp-cities-card-2-image-container">
                            <div class="pxp-cities-card-2-image pxp-cover" style="background-image: url(assets/images/city-1.jpg);"></div>
                        </div>
                        <div class="pxp-cities-card-2-info">
                            <div class="pxp-cities-card-2-name">San Francisco, CA</div>
                    ...
                    <a href="jobs-list-1.html" class="pxp-cities-card-2">
                        <div class="pxp-cities-card-2-image-container">
                            <div class="pxp-cities-card-2-image pxp-cover" style="background-image: url(assets/images/city-2.jpg);"></div>
                        </div>
                        <div class="pxp-cities-card-2-info">
                ...
                <div class="col-md-6 col-xl-4 col-xxl-3">
                    <a href="jobs-list-1.html" class="pxp-cities-card-2">
                        <div class="pxp-cities-card-2-image-container">
                            <div class="pxp-cities-card-2-image pxp-cover" style="background-image: url(assets/images/city-5.jpg);"></div>
                        </div>
                        <div class="pxp-cities-card-2-info">
                            <div class="pxp-cities-card-2-name">London, UK</div>
                            <div class="pxp-cities-card-2-jobs">452 open positions</div>
    ...
    <!-- Section End {Featured Cities} -->

    <!-- Section Start {Stay Up To Date} -->
    <section class="mt-100">
        <div class="pxp-container">
                ...
                <div class="col-md-9 col-lg-7 col-xl-6 col-xxl-5">
                    <div class="pxp-subscribe-1-container pxp-animate-in pxp-animate-in-top">
                        <div class="pxp-subscribe-1-image">
                            <img src="assets/images/subscribe.png" alt="Stay Up to Date">
                        </div>
