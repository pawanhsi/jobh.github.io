...
<?php include('include/header.php'); ?><div class="pxp-dashboard-side-panel d-none d-lg-block">
    <div class="pxp-logo">
    ...
    <nav class="mt-3 mt-lg-4 d-flex justify-content-between flex-column pb-100">
        ...
        <ul class="list-unstyled">
            ...
            <li class="pxp-active"><a href="candidate-dashboard-applications.php"><span class="fa fa-file-text-o"></span>Apllications</a></li>
