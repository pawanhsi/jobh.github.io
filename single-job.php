        ...
        <div class="pxp-single-job-content pxp-has-columns">
            <div class="row">
                <div class="col-lg-7 col-xl-8 col-xxl-9">
                    <div class="pxp-single-job-cover pxp-cover" style="background-image: url(assets/images/office-2.jpg);"></div>
                    <div class="pxp-single-job-cover-logo" style="background-image: url(assets/images/company-logo-2.png);"></div>

                    <div class="row justify-content-between align-items-center mt-4 mt-lg-5">
                        <div class="col-xl-8 col-xxl-6">
                            <h1>Software Engineering Team Leader</h1>
                            <div class="pxp-single-job-company-location">
                                by <a href="single-company-1.html" class="pxp-single-job-company">Craftgenics</a> in 
                                <a href="jobs-list-1.html" class="pxp-single-job-location">Los Angeles, CA</a>
                            </div>
                        </div>
                        <div class="col-auto">
                        ...
                        <div class="row mt-4 justify-content-between align-items-center">
                            <div class="col-6">
                                <a href="jobs-list-1.html" class="pxp-single-job-category">
                                    ...
                                    <div class="pxp-single-job-category-label">Project Management</div>
                                </a>
                            </div>
                            <div class="col-auto">
                                <div class="pxp-single-job-date pxp-text-light">4 days ago</div>
                            </div>
                        </div>
                        ...
                        <div class="pxp-single-job-content-details mt-4 mt-lg-5">
                            ...
                            <div class="mt-4">
                                <h4>Requirements</h4>
                                <ul><li>4+ years of system administration experience with the Microsoft Server platform (2012/2016, Microsoft IIS, Active Directory)</li><li>3+ years of hands-on system administration experience with AWS (EC2, Elastic Load Balancing, Multi AZ, etc.)</li><li>4+ years of SQL Server, MySQL</li><li>Working knowledge of Encryption techniques and protocols, Multi-factor authentication, Data protection, Penetration testing, Security threats</li><li>Bachelor's Degree, or 4+ years of hands-on IT experience</li></ul>
                            </div>
                            <div class="mt-4">
                                <h4>Skills</h4>
                    ...
                    <div class="col-lg-5 col-xl-4 col-xxl-3">
                        <div class="pxp-single-job-side-panel mt-5 mt-lg-0">
                            <div>
                                ...
                                <div class="pxp-single-job-side-info-data">Minimum 1 year</div>
                            </div>
                            <div class="mt-4">
                            ...
                            <div class="mt-4">
                                ...
                                <div class="pxp-single-job-side-info-data">$35k / year</div>
                            </div>
                        </div>
                        <div class="mt-3 mt-lg-4 pxp-single-job-side-panel">
                            <div class="pxp-single-job-side-company">
                                <div class="pxp-single-job-side-company-logo pxp-cover" style="background-image: url(assets/images/company-logo-2.png);"></div>
        ...
        <div class="pxp-container">
            ...
            <div class="row mt-3 mt-md-4 pxp-animate-in pxp-animate-in-top pxp-in">
                <div class="col-xl-6 pxp-jobs-card-2-container">
                    <div class="pxp-jobs-card-2 pxp-has-border">
                        <div class="pxp-jobs-card-2-top">
                            <a href="single-company-1.html" class="pxp-jobs-card-2-company-logo" style="background-image: url(assets/images/company-logo-2.png);"></a>
                ...
                <div class="col-xl-6 pxp-jobs-card-2-container">
                    <div class="pxp-jobs-card-2 pxp-has-border">
                        <div class="pxp-jobs-card-2-top">
                            <a href="single-company-1.html" class="pxp-jobs-card-2-company-logo" style="background-image: url(assets/images/company-logo-3.png);"></a>
                            <div class="pxp-jobs-card-2-info">
                        ...
                        <div class="pxp-jobs-card-2-bottom">
                            ...
                            <div class="pxp-jobs-card-2-bottom-right">
                                <span class="pxp-jobs-card-2-date pxp-text-light">3 days ago by</span> <a href="single-company-1.html" class="pxp-jobs-card-2-company">Illuminate Studio</a>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-xl-6 pxp-jobs-card-2-container">
                    <div class="pxp-jobs-card-2 pxp-has-border">
                        <div class="pxp-jobs-card-2-top">
                            <a href="single-company-1.html" class="pxp-jobs-card-2-company-logo" style="background-image: url(assets/images/company-logo-4.png);"></a>
                            <div class="pxp-jobs-card-2-info">
                ...
                <div class="col-xl-6 pxp-jobs-card-2-container">
                    <div class="pxp-jobs-card-2 pxp-has-border">
                        <div class="pxp-jobs-card-2-top">
                            <a href="single-company-1.html" class="pxp-jobs-card-2-company-logo" style="background-image: url(assets/images/company-logo-5.png);"></a>
                            <div class="pxp-jobs-card-2-info">
